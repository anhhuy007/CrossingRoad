...
public:
	...
	//Text
	Widget::Text design = Widget::Text(game, "DESIGNED BY TEAM 11 - HCMUS", { 111,73 }, 25, 34, TextFont::NORMAL);
	Widget::Text mssv1 = Widget::Text(game, "22127086 - Nguyen Lam Anh Duy", { 115,104 }, 15, 34, TextFont::NORMAL);
	Widget::Text mssv2 = Widget::Text(game, "22127149 - Huynh Anh Huy", { 92,150 }, 45, 34, TextFont::NORMAL);
	Widget::Text mssv3 = Widget::Text(game, "22127348 - Phan Nguyen Hoang Quan", { 110,180 }, 20, 34, TextFont::NORMAL);
	Widget::Text mssv4= Widget::Text(game, "Ngo Hoang Nam Hung", { 111,73 }, 25, 34, TextFont::NORMAL);
	Widget::Text instructor = Widget::Text(game, "Instructor - Truong Toan Thinh", { 115,104 }, 15, 34, TextFont::NORMAL);
